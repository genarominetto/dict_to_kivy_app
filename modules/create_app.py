...
def create_app(screen_dict, folder_name, app_name, title_height, transition='FadeTransition', compress_and_download=True):
    ...
    py_files, kv_files = create_screen_and_kv(screen_dict, title_height)
